...
import { Text, Keyboard, StyleSheet, View, TextInput, TouchableOpacity, SafeAreaView, ActivityIndicator, FlatList, Image } from 'react-native'
...
const HomeScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={{fontSize: 23, fontWeight: "800", width: "90%", color: "#FF5A5F"}}>
      ...
      <View style={{display: 'flex', flexDirection: "row",}}>
        ...
        style={[styles.inputField, {width: "20%", fontSize: 18, marginLeft: 15, color: "white", fontWeight: "bold"}]}
        ...
        renderItem={({ item }) => (
          ...
          <View style={{padding: 20, flexDirection: "row"}}>
            ...
            <TouchableOpacity onPress={() => {}}>
              <Text style={{marginLeft: 50, fontSize: 20, color: "#FF5A5F"}}>
                Details
              </Text>
            </TouchableOpacity>
          </View>
